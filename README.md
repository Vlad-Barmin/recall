...
Далее: импорт воркфлоу из `workflows/`, создание креденшлов (Telegram, OpenRouter, Postgres), публикация воркфлоу. Расписание и вебхуки работают только у опубликованных воркфлоу — сохранение создаёт черновик.
